                    ...
                    <div className="row mt-4">
                        ...
                        <div className="col-lg-4">
                            <div className="d-flex flex-column">
                                ...
                                <p className="tw-large"><i className="fal fa-mail-bulk left-icon"></i>test@gmail.com</p>
                                <p className="tw-large"><i className="fal fa-phone left-icon"></i>+84.123.456.789</p>
                                <p className="tw-large"><i className="fal fa-map-marker-alt left-icon"></i>Ho Chi Minh CiTy</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="footer-end">
                    <p>Copyright 2021<i className="fal fa-copyright"></i></p>
                </div>
            </div>
        );
}
